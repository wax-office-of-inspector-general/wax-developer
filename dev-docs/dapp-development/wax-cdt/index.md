...
Refer to our [Docker Quickstart](/wax-docs/dev-docs/docker_qstart) for more information.
...
- A [C/C++ API library](/wax-docs/dev-docs/cdt_api) to communicate with the WAX Blockchain
...
compile your smart contracts and create smart contract templates. Refer to [WAX-CDT Options](/wax-docs/dev-docs/cdt_options) for a list of tools and parameters.
