...
Next, we'll use WAX-CDT tools to deploy your NFT smart contract to the WAX mainnet. Refer to [WAX-CDT Deploy](/wax-docs/dev-docs/deploy_source) for more information.
