...
Refer to our [Docker Quickstart](/wax-developer/docs/docker_qstart) for more information.
...
- A [C/C++ API library](/wax-developer/docs/cdt_api) to communicate with the WAX Blockchain
...
compile your smart contracts and create smart contract templates. Refer to [WAX-CDT Options](/wax-developer/docs/cdt_options) for a list of tools and parameters.
