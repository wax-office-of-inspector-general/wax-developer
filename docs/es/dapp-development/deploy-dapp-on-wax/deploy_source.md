...
Before you begin, you'll need to compile your smart contract and have your WASM and ABI files ready. Refer to [Smart Contract Quickstart](/docs/es/dapp-development/smart-contract-quickstart) or [WAX-CDT Build Tools](/docs/es/dapp-development/wax-cdt/cdt_cpp) for more information.
