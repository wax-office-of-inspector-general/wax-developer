...
Refer to our [Docker Quickstart](/docs/es/dapp-development/docker-setup/) for more information.
...
- A [C/C++ API library](/docs/es/api-reference/cdt_api) to communicate with the WAX Blockchain
...
compile your smart contracts and create smart contract templates. Refer to [WAX-CDT Options](/docs/es/tools/cdt_options) for a list of tools and parameters.
