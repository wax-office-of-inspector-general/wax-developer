...
**Tip:** In the next few sections, we'll go over how everything works. If you'd like to jump right to the code and run our live WaxJS example, refer to [WaxJS Demo](/es/wax-cloud-wallet/waxjs/waxjs_demo).
{: .label .label-yellow }
...
* For tips on building and deploying smart contracts on the WAX Blockchain, refer to our [dApp Development](/es/dapp-development/) section. 
