...
* The [WCW Quickstart Guide](/es/wax-cloud-wallet/waxjs/waxjs_qstart) features tutorials, installation instructions, code samples, and a live demo
...
* Customers can automatically log into your dApp any time they access it using the [WaxJS feature](/es/wax-cloud-wallet/waxjs/)
