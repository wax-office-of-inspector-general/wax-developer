...
The WAX mainnet exposes a set of **nodeos** API endpoints (RPC API), allowing you to interact with the WAX Blockchain. In production, this API is accessed from some of the URLs you can get  in `https://validate.eosnation.io/wax/reports/endpoints.html`.
